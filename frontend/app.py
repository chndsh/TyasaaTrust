...
.block-container { padding-top: 2.5rem !important; padding-bottom: 3rem !important; max-width: 1100px !important; }
...
st.markdown('<p class="brand-mark">TyasaaTrust</p>', unsafe_allow_html=True)
st.markdown('<h1 class="page-title">Trust Intelligence Console</h1>', unsafe_allow_html=True)
st.markdown(
